# Software
For the Quantum deck I would recommend running linux on both versions but you can run windows and if you are then heres a table for what I’d recommend:
|      | N100        | I3-N305 |
|------|-------------|---------|
...
- Intel Serial IO Driver (if needed)
- Intel management engine (if needed)
